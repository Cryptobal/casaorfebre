...
async function main() {
  ...
  const planEsencial = await prisma.membershipPlan.upsert({
    ...
    create: {
      ...
      annualPrice: null,
      commissionRate: 0.18,
      features: ["10 productos activos", "3 fotos por pieza", "Soporte email", "Pago a 14 días de entrega confirmada"],
      maxProducts: 10,
  ...
  const products = [
    ...
    },
    {
      ...
      price: 89000,
      categorySlug: "collar",
      materialNames: ["Plata 950", "Piedra de mar"],
    ...
    },
    {
      ...
      price: 125000,
      categorySlug: "collar",
      materialNames: ["Plata 950", "Lapislázuli"],
      technique: "Cera perdida y engaste",
      dimensions: "Dije: 3.5 x 2.0 cm",
      weight: 14.0,
      productionType: "MADE_TO_ORDER" as const,
      stock: 1,
      status: "APPROVED" as const,
      publishedAt: new Date(),
    },
    ...
    },
    {
      ...
      price: 145000,
      categorySlug: "anillo",
      materialNames: ["Plata 950", "Amatista"],
    ...
    },
    {
      ...
      price: 78000,
      categorySlug: "broche",
      materialNames: ["Plata 950", "Baño de oro", "Turmalina"],
    ...
    },
    {
      ...
      price: 185000,
      categorySlug: "aros",
      materialNames: ["Plata 950", "Esmeralda"],
    ...
    },
    {
      ...
      price: 28000,
      categorySlug: "aros",
      materialNames: ["Cobre", "Semillas nativas", "Plata 950"],
    ...
    },
    {
      ...
      price: 58000,
      categorySlug: "collar",
      materialNames: ["Cobre", "Bronce", "Madera de lenga"],
  ...
  for (const product of products) {
    const { categorySlug, materialNames, ...productData } = product;
    const created = await prisma.product.upsert({
      ...
      create: {
        ...
        materials: {
          connectOrCreate: materialNames.map((name, i) => ({
            where: { name },
