    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <ProductForm
        ...
        product={{
          ...
          pendantWidth: product.pendantWidth,
          pendantHeight: product.pendantHeight,
          earringWidth: product.earringWidth,
          earringDrop: product.earringDrop,
          broochWidth: product.broochWidth,
          broochHeight: product.broochHeight,
          piercingGauge: product.piercingGauge,
          piercingBarLength: product.piercingBarLength,
          stones: product.stones.map((s) => ({
            id: s.id,
            stoneType: s.stoneType,
            stoneCarat: s.stoneCarat,
