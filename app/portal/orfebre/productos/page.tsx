          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-border bg-background">
              <tr>
                ...
                <th className="hidden px-4 py-3 font-medium text-text-secondary sm:table-cell">Categoria</th>
                ...
                <th className="hidden px-4 py-3 font-medium text-text-secondary sm:table-cell">Stock</th>
