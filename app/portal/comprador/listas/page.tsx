              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-border px-3 py-1.5 text-xs text-text-secondary transition-colors hover:bg-background"
                  >
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className="rounded-lg border border-border px-3 py-1.5 text-xs text-red-500 transition-colors hover:bg-red-50"
                  >
                    Eliminar
                  </button>
                </div>
