...
const FAQ_ITEMS = [
  ...
  { question: '\u00BFCuánto tarda la revisión de mi postulación?', answer: 'El formulario toma ~10 minutos. Evaluamos tu postulación en un plazo de 3 a 7 días hábiles y te notificamos por email con el resultado.' },
  { question: '\u00BFQué pasa si un comprador quiere devolver una pieza?', answer: 'Tenemos un proceso de devolución de 14 días. Si es por defecto de fabricación, Casa Orfebre cubre el envío. Si es cambio de preferencia, el comprador cubre el retorno. Mediamos todo el proceso para que sea justo para ambas partes.' },
