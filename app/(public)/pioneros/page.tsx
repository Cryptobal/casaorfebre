...
export const metadata: Metadata = {
  ...
  description:
    '3 meses con plan Maestro gratis: $0 de suscripci\u00f3n y 0% de comisi\u00f3n. S\u00e9 de los primeros orfebres en exhibir en la plataforma de joyer\u00eda de autor m\u00e1s importante de Chile. Cupos limitados.',
  keywords: [
  ...
  alternates: { canonical: 'https://casaorfebre.cl/pioneros' },
  openGraph: {
