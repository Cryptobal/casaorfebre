...
import { buyerPortalSteps } from "./tours/buyer-portal-tour";
import { checkTourStatus, completeTour } from "@/app/actions/tour-actions";

const TOUR_ID = "buyer-portal-v1";

export function BuyerPortalTour() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:inline">Guía de Mi Cuenta</span>
    </button>
  );
}
